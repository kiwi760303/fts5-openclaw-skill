#!/usr/bin/env python3
"""
OpenClaw PFSI Onboarding Wizard
Step-by-step setup guide for PFSI skill
"""
...
{BOLD}{CYAN}╔══════════════════════════════════════════════════════════════╗
║                                                              ║
║   {YELLOW}OpenClaw PFSI{ CYAN}                                          ║
║   {BLUE}Proactive Full-text Self-improving Integration{ CYAN}          ║
║   {BLUE}Version 2.0.0 - Onboarding Wizard{ CYAN}                     ║
║                                                              ║
╚══════════════════════════════════════════════════════════════╝{RESET}
""")
...
def get_api_key_guide() -> str:
    ...
    print(f"""  {BOLD}To use OpenClaw PFSI, you need a MiniMax API Key.{RESET}
...
def save_api_key(api_key: str) -> bool:
    ...
    try:
        with open(SETUP_FILE, 'w') as f:
            f.write(f"# OpenClaw PFSI Configuration\n")
            f.write(f"# Generated by PFSI Onboarding Wizard\n")
...
def run_full_setup():
    ...
    print(f"""
  {BOLD}Welcome to OpenClaw PFSI Onboarding!{RESET}

  This wizard will guide you through setting up PFSI:
...
def check_existing():
    ...
    if api_key:
        ...
        print(f"""
  {BOLD}✅ OpenClaw PFSI is already configured!{RESET}
...
""")
        ...
        print(f"""
  {YELLOW}OpenClaw PFSI is not configured yet.{RESET}
